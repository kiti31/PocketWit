...
public class NotePad extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(set == null)
        {
            notes.add("Add by Clicking Right Top Corner Button                      Delete by Highlighting the Note");
        }
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            {
                new AlertDialog.Builder(NotePad.this)                   // we can't use getApplicationContext() here as we want the activity to be the context, not the application
